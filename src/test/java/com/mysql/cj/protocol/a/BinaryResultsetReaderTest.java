...
public class BinaryResultsetReaderTest {
  @Rule
  public ExpectedException thrown = ExpectedException.none();
  @Test
  public void readTest() throws IOException {
    // Arrange
    BinaryResultsetReader binaryResultsetReader = new BinaryResultsetReader(
    ...
    binaryResultsetReader.read(1, true, resultPacket, metadata,
